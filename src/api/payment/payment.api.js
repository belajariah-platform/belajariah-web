...
const GetAllPayment = async (skip, take, filters, sort, search) =>  {
  try {
    ...
    ${Config.BELAJARIAH_MAIN_SERVICE}/payments?skip=${skip}&take=${take}&filter=${filters}&order=id|${sort}&search=${search}`,
    //headers
    )
    return response
  } catch (error) {
...
const GetAllPaymentReject = async (skip, take, filters, sort, search) =>  {
  try {
    //const headers = await Header()
    const response = await axios.get(`
    ${Config.BELAJARIAH_MAIN_SERVICE}/payments_reject?skip=${skip}&take=${take}&filter=${filters}&order=id|${sort}&search=${search}`,
    //headers
    )
    return response
  } catch (error) {
...
const GetAllPaymentByUserID = async (skip, take, filters, sort) =>  {
  try {
    //const headers = await Header()
    const response = await axios.get(`
      ${Config.BELAJARIAH_MAIN_SERVICE}/payment?skip=${skip}&take=${take}&filter=${filters}&order=id|${sort}`,
    //headers
    )
    return response
  } catch (error) {
...
const InsertPayment = async (formData) => {
  try {
    ...
    const response = await axios.post(
      `${Config.BELAJARIAH_MAIN_SERVICE}/payment`,
      formData,
    //  headers
    )
    return response
...
const ConfirmPayment = async (formData) => {
  try {
    ...
    const response = await axios.put(
      `${Config.BELAJARIAH_MAIN_SERVICE}/payment/confirm`,
      formData,
    //headers
    )
    return response
...
const UploadPayment = async (formData) => {
  try {
    //const headers = await Header()
    const response = await axios.put(
      `${Config.BELAJARIAH_MAIN_SERVICE}/payment/upload`,
      formData,
    //  headers
    )
    return response
...
const ChargeBankVA = async (data) => {
  ...
  try {
    const response = await axios.post(`${Config.PAYMENT_GATEWAY_ENDPOINT}/charge`, body,
    //HeaderPayment
    )
...
const GetTransaction = async (order_id) => {
  try {
    const response = await axios.get(`${Config.PAYMENT_GATEWAY_ENDPOINT}/${order_id}/status`,
    //HeaderPayment
    )
    return response.data
  } catch (error) {
